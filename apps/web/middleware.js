...
export async function middleware(request) {
  ...
  // Auth, possession-proof, webhook, cron, capability, health, and static
  // routes authenticate inside their own explicit authority boundary. Avoid a
  // consumer-session network call on those paths.
