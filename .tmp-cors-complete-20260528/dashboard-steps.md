...
Bucket: **`2mrrw-media`** (folders: `digital-assets/`, `images/`, `previews/`, `videos/`)
...
4. Replace the entire policy with `r2-cors-policy.json` from this bundle (same as `docs/reports/r2-cors-policy-recommended.json`).
5. Click **Save**.
6. Wait ~1 minute, then run `./verification-curls.sh` or review `curl-probes.txt`.
...
Do **not** use `pub-992d4f5d…r2.dev` — returns **401** regardless of CORS.
