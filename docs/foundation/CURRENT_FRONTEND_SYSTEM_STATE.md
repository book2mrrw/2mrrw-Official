...
Snapshot as of foundation lock **2026-05-19** at operational commit `b45a8d93905bd002cc36a6e1d9862fd0e967a10c` on branch `main` (UI origin `ce6ae20` via `foundation-stable-v1`).
