# Frontend recovery checkpoint: frontend-checkpoint-20260531-2044

**Timestamp:** 2026-06-01T01:44:35.883Z  
**Tag:** `frontend-checkpoint-20260531-2044`  
**Commit:** `7ee937bd6cf014c9f21c83e3e7c60fc3167ad35f`  
**Branch:** `main`  
**Subject:** Restore two-step Subscribe flow: Stripe on button click only

## Checkpoint note

Two-step subscribe flow restore
...
git checkout frontend-checkpoint-20260531-2044
npm ci
...
```bash
git push origin frontend-checkpoint-20260531-2044
```
