# Frontend recovery checkpoint: frontend-checkpoint-20260601-1247

**Timestamp:** 2026-06-01T17:47:45.999Z  
**Tag:** `frontend-checkpoint-20260601-1247`  
**Commit:** `8c9e6fc144f0ca1d51fef3933de9ab9911a79058`  
**Branch:** `main`  
**Subject:** Phase 14F: audibility truth, recoverAudioHard, iOS lifecycle

## Checkpoint note

Phase 14F audibility truth and recoverAudioHard iOS lifecycle
...
git checkout frontend-checkpoint-20260601-1247
npm ci
...
```bash
git push origin frontend-checkpoint-20260601-1247
```
