# Frontend recovery checkpoint: frontend-checkpoint-20260603-1428

**Timestamp:** 2026-06-03T19:28:02.259Z  
**Tag:** `frontend-checkpoint-20260603-1428`  
**Commit:** `97682691696b4335f25481f19a5d5fbed70903eb`  
**Branch:** `main`  
**Subject:** fix(playback): resume Web Audio inside iOS user gesture before queue

## Checkpoint note

Mobile remount audio Fix 1 release (iOS Web Audio gesture resume)

- Fix 1: iOS gesture resume, suspended play block, graph reconnect (`9768269`, `594c970` restore)
- Fix 2: deferred pending Phase 0 device branch (remount / Failure 1 not shipped)
- Doc trail on main: `9462032`, `68c5ccc` (`CHANGES_APPLIED.md` SHA alignment)
...
git checkout frontend-checkpoint-20260603-1428
npm ci
...
```bash
git push origin frontend-checkpoint-20260603-1428
```
