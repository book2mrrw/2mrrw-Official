# Frontend recovery checkpoint: frontend-checkpoint-20260531-1949

**Timestamp:** 2026-06-01T00:49:04.399Z  
**Tag:** `frontend-checkpoint-20260531-1949`  
**Commit:** `43d37ff4f7943d84422342e41b59cd0d3dfe28ab`  
**Branch:** `main`  
**Subject:** Fix OTP email intent isolation across email changes

## Checkpoint note

OTP email intent isolation fix
...
git checkout frontend-checkpoint-20260531-1949
npm ci
...
```bash
git push origin frontend-checkpoint-20260531-1949
```
