# Frontend recovery checkpoint: frontend-checkpoint-20260527-1217

**Timestamp:** 2026-05-27T17:17:12.341Z  
**Tag:** `frontend-checkpoint-20260527-1217`  
**Commit:** `b8445b79b6b9caee991cb0e2d30b170adfccc49d`  
**Branch:** `main`  
**Subject:** fix(auth): use createBrowserClient from @supabase/ssr for cookie-based session on mobile Safari
...
git checkout frontend-checkpoint-20260527-1217
npm ci
...
```bash
git push origin frontend-checkpoint-20260527-1217
```
