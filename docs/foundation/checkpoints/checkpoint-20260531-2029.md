# Frontend recovery checkpoint: frontend-checkpoint-20260531-2029

**Timestamp:** 2026-06-01T01:29:47.075Z  
**Tag:** `frontend-checkpoint-20260531-2029`  
**Commit:** `9ba0b8744e3c4ba2a85fa1eaf74f141801cac5e7`  
**Branch:** `main`  
**Subject:** Entitlement-only Subscribe flow and global Subscribe button gating

## Checkpoint note

Subscribe entitlement gating across platforms
...
git checkout frontend-checkpoint-20260531-2029
npm ci
...
```bash
git push origin frontend-checkpoint-20260531-2029
```
