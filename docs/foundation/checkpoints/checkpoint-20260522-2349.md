# Frontend recovery checkpoint: frontend-checkpoint-20260522-2349

**Timestamp:** 2026-05-23T04:49:36.947Z  
**Tag:** `frontend-checkpoint-20260522-2349`  
**Commit:** `81a3bebba75be91d2d8b199a3271c43c2b1b385e`  
**Branch:** `main`  
**Subject:** feat: apply hero glow to full heading text on both auth screens
...
git checkout frontend-checkpoint-20260522-2349
npm ci
...
```bash
git push origin frontend-checkpoint-20260522-2349
```
