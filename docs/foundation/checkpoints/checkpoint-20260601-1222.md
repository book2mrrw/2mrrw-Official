# Frontend recovery checkpoint: frontend-checkpoint-20260601-1222

**Timestamp:** 2026-06-01T17:22:18.517Z  
**Tag:** `frontend-checkpoint-20260601-1222`  
**Commit:** `87fe9edf7e6fe4b4c3d4be5a7db1054846db931d`  
**Branch:** `main`  
**Subject:** Reorder home sections: Radio after Albums and Mixtapes

## Checkpoint note

Home section order: Radio after Albums and Mixtapes
...
git checkout frontend-checkpoint-20260601-1222
npm ci
...
```bash
git push origin frontend-checkpoint-20260601-1222
```
