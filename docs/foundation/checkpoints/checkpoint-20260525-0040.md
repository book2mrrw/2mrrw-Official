# Frontend recovery checkpoint: frontend-checkpoint-20260525-0040

**Timestamp:** 2026-05-25T05:40:18.328Z  
**Tag:** `frontend-checkpoint-20260525-0040`  
**Commit:** `01c64a8e570df9aa0866cb1457e7158f6ef322d7`  
**Branch:** `main`  
**Subject:** fix: restore playback — entitled full stream, R2 public CDN, playback hardening

## Checkpoint note

Playback + R2 CDN fix — production deploy
...
git checkout frontend-checkpoint-20260525-0040
npm ci
...
```bash
git push origin frontend-checkpoint-20260525-0040
```
