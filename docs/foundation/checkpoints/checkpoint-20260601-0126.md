# Frontend recovery checkpoint: frontend-checkpoint-20260601-0126

**Timestamp:** 2026-06-01T06:26:37.718Z  
**Tag:** `frontend-checkpoint-20260601-0126`  
**Commit:** `95305360c10b6a2a7f4b0c4b505193d2d0147059`  
**Branch:** `main`  
**Subject:** Entitlement snapshot and refresh gating to reduce account-state churn

## Checkpoint note

Entitlement snapshot refresh gating
...
git checkout frontend-checkpoint-20260601-0126
npm ci
...
```bash
git push origin frontend-checkpoint-20260601-0126
```
