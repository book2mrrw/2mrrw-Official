# Frontend recovery checkpoint: frontend-checkpoint-20260525-0906

**Timestamp:** 2026-05-25T14:06:08.619Z  
**Tag:** `frontend-checkpoint-20260525-0906`  
**Commit:** `317a4d163517f75323f738bcc983f503f9f86171`  
**Branch:** `main`  
**Subject:** feat: storefront phase 2 — feature immersive modal and preview-end CTA

## Checkpoint note

Storefront phase 2 — feature modal + preview CTA deploy
...
git checkout frontend-checkpoint-20260525-0906
npm ci
...
```bash
git push origin frontend-checkpoint-20260525-0906
```
