# Frontend recovery checkpoint: frontend-checkpoint-20260601-0843

**Timestamp:** 2026-06-01T13:43:09.207Z  
**Tag:** `frontend-checkpoint-20260601-0843`  
**Commit:** `8f65cc9ddf0c8661a45830b17ac2df996cbfcc47`  
**Branch:** `main`  
**Subject:** Fix SSR audio-engine ref split and entitlement snapshot hydration.

## Checkpoint note

SSR audio-engine ref split deploy
...
git checkout frontend-checkpoint-20260601-0843
npm ci
...
```bash
git push origin frontend-checkpoint-20260601-0843
```
