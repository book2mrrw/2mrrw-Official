...
|-----------|-------|-------|
| Operational anchor | `8496fa7` | See `docs/foundation/recovery-anchor.json` |
...
| Sacred tag v2 | `foundation-stable-v2` | Annotated tag on operational anchor (`8496fa7`); full recovery |
