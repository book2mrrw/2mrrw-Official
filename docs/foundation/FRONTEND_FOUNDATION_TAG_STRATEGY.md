...
|-----------|-------|-------|
| Operational anchor | `e13b192` | See `docs/foundation/recovery-anchor.json` |
...
| Sacred tag v2 | `foundation-stable-v2` | Annotated tag on operational anchor (`e13b192`); full recovery |
