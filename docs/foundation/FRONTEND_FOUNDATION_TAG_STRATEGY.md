...
|-----------|-------|-------|
| Operational anchor | `b45a8d9` | See `docs/foundation/recovery-anchor.json` |
...
| Sacred tag v2 | `foundation-stable-v2` | Annotated tag on operational anchor (`b45a8d9`); full recovery |
