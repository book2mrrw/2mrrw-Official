        ...
        return toPlaybackTrack(
          {
            ...
            preview: album.preview,
            audio: album.audio,
            csAudio: album.csAudio || album.cs_audio,
            csCover: album.csCover || album.cs_cover,
            coverArtType: album.coverArtType || album.cover_art_type,
            csCoverType: album.csCoverType || album.cs_cover_type,
          },
          accountState,
          source,
          { trackIndex: index }
