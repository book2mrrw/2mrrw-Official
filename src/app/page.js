...
  // ── CAROUSEL with slide + fade animation ─────────────────────────────────
...
  // Shared carousel UI for both HOME and SINGLES tabs
...
      {/* COVER ART with slide+fade animation */}
      <div style={{ flexShrink: 0, width: large ? 300 : 260, height: large ? 300 : 260 }}>
        <img
          key={singleIndex}
...
            style={{ padding: large ? "11px 20px" : "10px 18px", background: "#1f1f1f", color: "white", border: "1px solid #333", borderRadius: 8, cursor: "pointer", fontSize: 13, transition: "0.25s" }}>
            ▶ Preview
          </button>
...
            {/* 2MRRW logo — moved to top-left so it doesn't overlap socials */}
            <div style={{ position: "absolute", top: 25, left: 25, fontSize: 42, fontWeight: 900, letterSpacing: 8, animation: "pulse 2.5s infinite", textShadow: "0 0 20px rgba(0,255,255,0.8)" }}>
              2MRRW
            </div>

            {/* SOCIAL BAR — bottom right, full width of hero */}
            <div style={{ position: "absolute", bottom: 24, right: 25, display: "flex", gap: 18, alignItems: "center", zIndex: 10 }}>
              {SOCIALS.map((social) => (
