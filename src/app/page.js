...
const exclusiveItems = [
  {
    id: "exc-card-tbh",
    title: "T.B.H. Collector Art Card",
    subtitle: "First Edition · #/100",
    type: "collector-card",
    cover: "/images/albums/tbh.jpg",
    price: 89.99,
    description: "4×6 premium matte card, 400gsm thick stock. Hand-signed with a personal message. QR code links directly to the T.B.H. digital album. Ships in an acrylic display case.",
    features: ["Hand-signed by 2MRRW", "QR code → digital album access", "400gsm soft-touch matte finish", "Acrylic display case included", "Numbered 1 of 100"],
    stock: 23,
    badge: "FIRST EDITION",
    badgeColor: "#00ffff",
    slug: "exc-card-tbh",
  ...
  {
    id: "exc-card-ad",
    title: "(A.D.) Collector Art Card",
    subtitle: "Early Supporter Series · #/50",
    type: "collector-card",
    cover: "/images/albums/ad.jpg",
    price: 99.99,
    description: "5×5 premium card with embedded NFC chip. Tap your phone to unlock exclusive fan content. Hand-signed. Ships in a magnetic enclosure. Limited to 50 pieces worldwide.",
    features: ["NFC chip — tap to open exclusive portal", "Hand-signed by 2MRRW", "500gsm with magnetic enclosure", "Numbered 1 of 50", "Inner Circle access granted"],
    stock: 11,
  ...
  {
    id: "exc-bundle-lovehz",
    title: "Love Hz Vol.1 Launch Bundle",
    subtitle: "Collector Bundle · Launch Edition",
    type: "bundle",
    cover: "/images/albums/lovehz.jpg",
    price: 149.99,
    description: "Full digital album + collector art card + hand-signed lyric sheet. Exclusive to launch supporters. This is ownership. Not just music.",
    features: ["Digital album — instant download", "Collector art card (numbered)", "Hand-signed lyric sheet", "Early listener credit", "Inner Circle badge unlocked"],
    stock: 7,
    badge: "LAUNCH BUNDLE",
    badgeColor: "#a259ff",
    slug: "exc-bundle-lovehz",
  },
  {
    id: "exc-signed-vinyl",
    title: "Signed Vinyl — T.B.H.",
    subtitle: "Hand-Signed · Limited Press",
    type: "vinyl",
    cover: "/images/albums/tbh.jpg",
    price: 74.99,
    description: "T.B.H. on wax, hand-signed on the sleeve. Limited press. This is the record you pull out and show people. The one that started it.",
    features: ["Hand-signed sleeve by 2MRRW", "Limited press run", "Ships in protective sleeve", "Certificate of authenticity", "Collector-grade packaging"],
    stock: 14,
    badge: "SIGNED",
    badgeColor: "#00ffff",
    slug: "exc-signed-vinyl",
  },
];
...
const circleResponses = [
  {
    id: "resp-1",
    question: "What does 2MRRW actually mean to you personally?",
    questionBy: "EarlyFan_J",
    questionTime: "March 15, 2026",
    response: "It means tomorrow is always possible. No matter how heavy today gets, you hold on because tomorrow is a blank page. That's the whole movement — not optimism, just possibility.",
    tag: "VISIONARY PICK",
    tagColor: "#a259ff",
    highlight: true,
  },
  {
    id: "resp-2",
    question: "How do you decide which songs make the album vs. which stay unreleased?",
    questionBy: "Listener_K",
    questionTime: "March 28, 2026",
    response: "The ones that make it are the ones that still hurt when I listen back. If I can hear it and feel nothing — it's not ready for you. If it still cuts, it's real enough to share.",
    tag: "FEATURED",
    tagColor: "#00ffff",
    highlight: false,
  },
  {
    id: "resp-3",
    question: "Will there be a Love Hz Vol.2?",
    questionBy: "Collector_001",
    questionTime: "April 5, 2026",
    response: "Already working on it. Vol.1 was the introduction to the frequency. Vol.2 is what happens when the signal locks in. You'll feel the difference.",
...
export default function Page() {
  ...
  const addVinylToCart = (single) => {
    addToCart({ title: `${single.title} – Vinyl`, slug: `${single.slug}-vinyl`, cover: single.cover, price: 47.99 });
  };
  ...
  const getShowsForDay = (day) => shows.filter((s) => {
  ...
  const CarouselUI = ({ large }) => (
    <div style={{
      ...
      padding: large ? "32px 28px" : "28px 24px",
      ...
      <div style={{ flexShrink: 0, width: large ? 340 : 300, height: large ? 340 : 300, position: "relative" }}
        ...
        <img
          ...
          style={{
            width: "100%", height: "100%", borderRadius: large ? 18 : 16,
        ...
        <div
          ...
          style={{
            ...
            borderRadius: large ? 18 : 16, cursor: "pointer",
          ...
          <div style={{ fontSize: 12, fontWeight: 700, letterSpacing: 2, color: "rgba(255,255,255,0.85)", textTransform: "uppercase" }}>
            Preview
          </div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: large ? 14 : 12 }}>
        <div
          ...
          style={{
            fontSize: large ? 30 : 26, fontWeight: 900, letterSpacing: 2,
            animation: animating ? "fadeOut 0.32s ease forwards" : "fadeInUp 0.35s ease forwards",
          }}>
          {currentSingle.title}
        </div>
        <div style={{ fontSize: 13, color: "#555", letterSpacing: 1 }}>
          SINGLE{large ? ` · ${singleIndex + 1} of ${singles.length}` : ""}
        </div>
    ...
    <>
      ...
      {!gateSubmitted && (
        <div style={{
          ...
          <input
            placeholder="Full Name" value={gateName}
          ...
          <input
            placeholder="Phone Number" value={gatePhone}
            onChange={(e) => setGatePhone(e.target.value)}
            onKeyDown={handleGateKeyDown}
            style={{ width: 280, padding: "10px 14px", background: "#111", border: "1px solid #333", color: "white", borderRadius: 8, fontSize: 14 }} />
          <input
            placeholder="Email Address" value={gateEmail}
          ...
          <div onClick={(e) => e.stopPropagation()}
            ...
            <div style={{ width: "100%", marginTop: 4 }}>
              ...
              {selectedAlbum.tracks.map((track, i) => (
                <div key={i} style={{ padding: "6px 0", fontSize: 13, borderBottom: "1px solid #1a1a1a", color: "white" }}>{i + 1}. {track}</div>
              ))}
            </div>
            ...
            <button onClick={() => { addToCart({ title: `${selectedAlbum.title} – Vinyl`, slug: `${selectedAlbum.slug}-vinyl`, cover: selectedAlbum.cover, price: selectedAlbum.vinyl }); setSelectedAlbum(null); }}
              style={{ width: "100%", padding: "10px 0", background: "#0a0a0a", color: "#00ffff", border: "1px solid #00ffff", borderRadius: 8, cursor: "pointer", fontSize: 13, fontWeight: "bold" }}>
      ...
      {selectedEvent && (
        <div onClick={() => setSelectedEvent(null)}
          ...
          <div onClick={(e) => e.stopPropagation()}
            ...
            <button onClick={() => { addToCart({ title: `Ticket – ${selectedEvent.title}`, slug: selectedEvent.id, cover: null, price: selectedEvent.price }); setSelectedEvent(null); }}
      ...
      {/* EXCLUSIVE ITEM MODAL */}
      {exclusiveModal && (
        <div onClick={() => setExclusiveModal(null)}
          style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.92)", zIndex: 8888, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
          <div onClick={(e) => e.stopPropagation()}
            style={{ background: "#0d0d0d", border: `1px solid ${exclusiveModal.badgeColor}33`, borderRadius: 24, padding: 32, width: 380, maxHeight: "80vh", overflowY: "auto", display: "flex", flexDirection: "column", gap: 16, boxShadow: `0 0 60px ${exclusiveModal.badgeColor}22` }}>
            <div style={{ position: "relative" }}>
              <img src={exclusiveModal.cover} style={{ width: "100%", height: 200, borderRadius: 14, objectFit: "cover", display: "block" }} />
              <div style={{ position: "absolute", top: 12, left: 12, background: exclusiveModal.badgeColor, color: "#000", fontSize: 10, fontWeight: 900, letterSpacing: 2, padding: "4px 10px", borderRadius: 20 }}>
                {exclusiveModal.badge}
              </div>
            </div>
            ...
            <div style={{ borderTop: "1px solid #1e1e1e", paddingTop: 16 }}>
              ...
              {exclusiveModal.features.map((f, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 0", fontSize: 13, color: "#ccc", borderBottom: "1px solid #111" }}>
                  <span style={{ color: exclusiveModal.badgeColor, fontSize: 16, lineHeight: 1 }}>✓</span> {f}
                </div>
              ))}
            </div>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 4 }}>
              ...
              <button
                onClick={() => { addToCart({ title: exclusiveModal.title, slug: exclusiveModal.slug, cover: exclusiveModal.cover, price: exclusiveModal.price }); setExclusiveModal(null); }}
                style={{ padding: "12px 24px", background: exclusiveModal.badgeColor, color: "#000", fontWeight: 900, border: "none", borderRadius: 10, cursor: "pointer", fontSize: 14, letterSpacing: 1 }}>
                Add to Cart
              </button>
            </div>
      ...
      <div style={{ display: "flex", minHeight: "100vh", background: "#050505", color: "white" }}>
        <div style={{ flex: 3, padding: 30 }}>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button key={tab.id} onClick={() => setActiveTab(tab.id)}
                  style={{ padding: "8px 16px", fontSize: 11, fontWeight: 700, letterSpacing: 2, cursor: "pointer", border: isActive ? "1px solid #00ffff" : "1px solid #2a2a2a", borderRadius: 30, background: isActive ? "linear-gradient(135deg, rgba(0,255,255,0.15), rgba(0,255,255,0.05))" : "rgba(255,255,255,0.03)", color: isActive ? "#00ffff" : "#555", textShadow: isActive ? "0 0 10px rgba(0,255,255,0.6)" : "none", boxShadow: isActive ? "0 0 12px rgba(0,255,255,0.2), inset 0 0 8px rgba(0,255,255,0.05)" : "none", transition: "all 0.25s ease", backdropFilter: "blur(4px)" }}
                  onMouseEnter={(e) => { if (!isActive) { e.currentTarget.style.borderColor = "#444"; e.currentTarget.style.color = "#aaa"; e.currentTarget.style.background = "rgba(255,255,255,0.06)"; } }}
                  onMouseLeave={(e) => { if (!isActive) { e.currentTarget.style.borderColor = "#2a2a2a"; e.currentTarget.style.color = "#555"; e.currentTarget.style.background = "rgba(255,255,255,0.03)"; } }}>
                  {tab.label}
                </button>
              );
            })}
          ...
          {activeTab === "exclusive" && (
            <>
              ...
              <p style={{ fontSize: 13, color: "#444", marginBottom: 8, letterSpacing: 1, lineHeight: 1.8 }}>
                This is not merch. These are ownership tokens. Physical and digital proof that you were here first.
              </p>
                ...
                {exclusiveItems.map((item) => (
                  <div key={item.id}
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <div style={{ position: "absolute", top: 12, left: 12, background: item.badgeColor, color: "#000", fontSize: 9, fontWeight: 900, letterSpacing: 2, padding: "4px 10px", borderRadius: 20 }}>
                        {item.badge}
                      </div>
                      <div style={{ position: "absolute", top: 12, right: 12, background: "rgba(0,0,0,0.7)", color: "#fff", fontSize: 10, fontWeight: 700, padding: "3px 8px", borderRadius: 10, backdropFilter: "blur(4px)" }}>
                        {item.stock} left
                      </div>
                    </div>
                    <div style={{ padding: "16px 18px 20px" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        ...
                        <button
                          onClick={(e) => { e.stopPropagation(); setExclusiveModal(item); }}
              ...
              <div style={{ marginTop: 48, background: "linear-gradient(135deg, #0d0d0d, #111)", border: "1px solid #1e1e1e", borderRadius: 20, padding: 32 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 20 }}>
                  {[
                    { icon: "🃏", title: "Physical Card", desc: "350–600gsm thick stock. Matte soft-touch finish. Luxury feel designed to last." },
                    { icon: "✍️", title: "Hand-Signed", desc: "Personal message from 2MRRW. Each card is individually signed and numbered." },
                    { icon: "📱", title: "QR + NFC", desc: "Scan to access your music library. Select cards include NFC chip — tap to unlock." },
                    { icon: "🔒", title: "Scarcity Built In", desc: "First Edition, Early Supporter Series, numbered drops. Once they're gone, they're gone." },
                  ].map((f) => (
                ...
                {musicVideos.map((vid) => (
                  <div key={vid.id} style={{ background: "#0e0e0e", border: "1px solid #1e1e1e", borderRadius: 20, overflow: "hidden" }}>
                    <div style={{ position: "relative", paddingBottom: "56.25%", height: 0 }}>
                      <iframe src={`https://www.youtube.com/embed/${vid.youtubeId}`} title={vid.title} frameBorder="0"
            ...
            <>
              ...
              <div style={{ background: "linear-gradient(135deg, #080808, #0d0d0d)", border: "1px solid #1a1a1a", borderRadius: 20, padding: "36px 32px", marginBottom: 28, textAlign: "center" }}>
                ...
                <div style={{ display: "flex", justifyContent: "center", gap: 16, flexWrap: "wrap" }}>
                  {[
                    { value: liveCountdown.days, label: "Days" },
                    { value: liveCountdown.hours, label: "Hours" },
                    { value: liveCountdown.minutes, label: "Min" },
                    { value: liveCountdown.seconds, label: "Sec" },
                  ].map((unit) => (
                    <div key={unit.label} style={{ background: "#0a0a0a", border: "1px solid #1e1e1e", borderRadius: 14, padding: "18px 22px", minWidth: 74, textAlign: "center" }}>
                      <div style={{ fontSize: 36, fontWeight: 900, color: "#00ffff", fontVariantNumeric: "tabular-nums", lineHeight: 1 }}>
                ...
                <button
                  onClick={() => setSelectedEvent(shows[0])}
                  style={{ marginTop: 28, padding: "12px 32px", background: "#00ffff", color: "#000", fontWeight: 900, border: "none", borderRadius: 10, cursor: "pointer", fontSize: 14, letterSpacing: 1 }}>
                  Get Tickets – $25.00
                </button>
              </div>
                  ...
                  <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 16 }}>
                    <div style={{ width: 70, height: 70, borderRadius: "50%", border: "1px solid #222", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <svg viewBox="0 0 24 24" fill="#333" width="32" height="32">
                        ...
                        <path d="M20.188 10.934a8.999 8.999 0 0 0-16.376 0M23.472 9.16a13.5 13.5 0 0 0-22.944 0M16.905 12.7a4.5 4.5 0 0 0-9.81 0M12 17v-1m0 5v-2" stroke="#333" strokeWidth="1.5" fill="none" />
                      </svg>
                    </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {shows.map((show) => (
                  <div key={show.id}
                    style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "14px 18px", background: "#0a0a0a", border: "1px solid #1a1a1a", borderRadius: 12, gap: 12, flexWrap: "wrap", transition: "0.2s" }}
                    ...
                    <button onClick={() => setSelectedEvent(show)}
                  ...
                  <div style={{ borderTop: "1px solid #1e1e1e", paddingTop: 24 }}>
                    ...
                    <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
                      ...
                      <button onClick={() => handleAddComment(blogPost.id)}
                        style={{ padding: "10px 18px", background: "#00ffff", color: "#000", fontWeight: "bold", border: "none", borderRadius: 8, cursor: "pointer", fontSize: 13 }}>Post</button>
                    </div>
                  </div>
                </div>
              ) : (
          ...
          {activeTab === "vision" && (
            <>
              ...
              <div style={{ background: "linear-gradient(135deg, #080808, #0e0e0e)", border: "1px solid #1a1a1a", borderRadius: 24, padding: "48px 40px", marginBottom: 28, textAlign: "center", position: "relative", overflow: "hidden" }}>
                ...
                <div style={{ fontSize: 52, fontWeight: 900, letterSpacing: 8, color: "white", textShadow: "0 0 40px rgba(0,255,255,0.3)", marginBottom: 20, lineHeight: 1 }}>
                  2MRRW
                </div>
                <div style={{ fontSize: 16, color: "#777", letterSpacing: 2, fontStyle: "italic" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                {[
                  {
                    label: "The Name",
                    heading: "What 2MRRW Means",
                    body: "2MRRW started as a reminder, not a brand. A reminder that no matter how hard today is, tomorrow is a blank page. You get to start again. The number 2 is intentional — it's shorthand for the second chance, the next version, the one that gets it right.\n\nEvery record, every show, every piece of merch carries that forward. If you're listening, you're part of the movement.",
                  },
                  {
                    label: "The Music",
                    heading: "Artist Philosophy",
                    body: "Music is not background noise. It's a conversation. 2MRRW makes music that holds something real — real emotion, real experience, real questions. Not manufactured for playlists. Built for people who feel deeply.\n\nThe goal is never to chase what's popular. The goal is to make something that still means something in 10 years. That's the standard every project is held to.",
                  },
                  {
                    label: "The Mission",
                    heading: "What This Is Building",
                    body: "This is not a streaming play. This is an ecosystem. Direct-to-fan. Artist-owned. Built on trust between creator and believer.\n\nThe music is the entry point. The community is the foundation. The collector system is the bridge between listening and belonging. Every piece is connected. Every purchase, every comment, every ticket is a step deeper into something that's being built in real time.\n\nListeners come and go. Fans stay. Believers build the movement.",
                  },
                ].map((section, i) => (
              ...
              <div style={{ marginTop: 32, padding: "28px 30px", borderTop: "1px solid #1a1a1a", textAlign: "center" }}>
                <div style={{ fontSize: 13, color: "#555", lineHeight: 2 }}>
                  ...
                  <span style={{ color: "#00ffff", fontWeight: 700 }}>You are early.</span>
                </div>
              </div>
            </>
          )}
          ...
          {activeTab === "circle" && (
            <>
              <div style={{ display: "flex", alignItems: "baseline", gap: 12, marginBottom: 6 }}>
                ...
                {userStatus && (
                  <div style={{ fontSize: 10, fontWeight: 900, letterSpacing: 2, padding: "3px 10px", borderRadius: 20, background: userStatus.glow + "22", color: userStatus.color, border: `1px solid ${userStatus.color}44`, boxShadow: `0 0 10px ${userStatus.glow}` }}>
                    {userStatus.label}
                  </div>
                )}
              </div>
              ...
              <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 20, padding: 28, marginBottom: 32 }}>
                ...
                <div style={{ display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap" }}>
                  {["question", "thought", "feedback", "message"].map((cat) => (
                    <button key={cat} onClick={() => setCircleCategory(cat)}
                      style={{ padding: "6px 14px", fontSize: 11, fontWeight: 700, letterSpacing: 1, cursor: "pointer", border: circleCategory === cat ? "1px solid #00ffff" : "1px solid #2a2a2a", borderRadius: 20, background: circleCategory === cat ? "rgba(0,255,255,0.1)" : "transparent", color: circleCategory === cat ? "#00ffff" : "#555", textTransform: "uppercase", transition: "0.2s" }}>
                      {cat}
                    </button>
                  ))}
                </div>
                <textarea
                  ...
                  onChange={(e) => setCircleQuestion(e.target.value)}
                  rows={4}
                  style={{ width: "100%", padding: "12px 14px", background: "#0a0a0a", border: "1px solid #2a2a2a", color: "white", borderRadius: 12, fontSize: 14, resize: "vertical", outline: "none", boxSizing: "border-box", fontFamily: "inherit", lineHeight: 1.7 }}
                />
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 12 }}>
                  <div style={{ fontSize: 12, color: "#444" }}>
                    {currentUser ? `Posting as ${currentUser.name}` : "Posting anonymously"}
                  </div>
                  <button onClick={handleCircleSubmit}
                    style={{ padding: "10px 24px", background: circleSubmitted ? "#1a3a1a" : "#00ffff", color: circleSubmitted ? "#00ff88" : "#000", fontWeight: 900, border: "none", borderRadius: 10, cursor: "pointer", fontSize: 13, transition: "0.3s", letterSpacing: 1 }}>
                    {circleSubmitted ? "✓ Submitted" : "Submit"}
                  </button>
                </div>
                {circleSubmitted && (
                  <div style={{ marginTop: 12, fontSize: 12, color: "#00ff88", letterSpacing: 0.5 }}>
                    Your message was received. If selected, 2MRRW will respond here in the archive.
                  </div>
                )}
              </div>
                  ...
                  <div key={resp.id}
                    ...
                    <div style={{ marginBottom: 16 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 8 }}>
                        ...
                        <div>
                          <div style={{ fontSize: 12, fontWeight: 700, color: "#aaa" }}>{resp.questionBy}</div>
                          <div style={{ fontSize: 10, color: "#444" }}>{resp.questionTime}</div>
                        </div>
                      </div>
                    ...
                    <div style={{ borderTop: "1px solid #1a1a1a", paddingTop: 16 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                        ...
                        <div style={{ fontSize: 10, fontWeight: 900, letterSpacing: 1, padding: "2px 8px", borderRadius: 10, background: resp.tagColor + "22", color: resp.tagColor, border: `1px solid ${resp.tagColor}44` }}>
                          {resp.tag}
                        </div>
                      </div>
              ...
              <div style={{ background: "linear-gradient(135deg, #0a0a14, #0d0d0d)", border: "1px solid #1a1a2a", borderRadius: 20, padding: "28px 30px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: 14 }}>
                  {[
                    { label: "EARLY SUPPORTER", color: "#aaa", desc: "Joined the ecosystem early. You were here." },
                    { label: "COLLECTOR", color: "#ff6b35", desc: "Purchased a collector card or bundle. You own a piece." },
                    { label: "VISIONARY", color: "#00ffff", desc: "3+ Circle submissions. You're part of the conversation." },
                    { label: "INNER CIRCLE", color: "#a259ff", desc: "Collector + Circle member. The deepest level of access." },
                  ].map((s) => (
              ...
              {!currentUser ? (
                ...
                <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 20, padding: "48px 32px", textAlign: "center" }}>
                  ...
                  <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
                    <button onClick={() => setActiveTab("singles")} style={{ padding: "10px 22px", background: "#111", color: "#00ffff", border: "1px solid #00ffff44", borderRadius: 8, cursor: "pointer", fontSize: 13, fontWeight: 700 }}>Browse Singles</button>
                    <button onClick={() => setActiveTab("albums")} style={{ padding: "10px 22px", background: "#111", color: "#aaa", border: "1px solid #333", borderRadius: 8, cursor: "pointer", fontSize: 13, fontWeight: 700 }}>Browse Albums</button>
                    <button onClick={() => setActiveTab("exclusive")} style={{ padding: "10px 22px", background: "#111", color: "#a259ff", border: "1px solid #a259ff44", borderRadius: 8, cursor: "pointer", fontSize: 13, fontWeight: 700 }}>Exclusive Drops</button>
                  </div>
                </div>
              ) : (
                <>
                  <div style={{ fontSize: 13, color: "#555", marginBottom: 24 }}>
                    {myPurchases.length} item{myPurchases.length !== 1 ? "s" : ""} in your library · Signed in as {currentUser.name}
                  </div>
                      ...
                      <div key={i} style={{ background: "#0a0a0a", border: "1px solid #1a1a1a", borderRadius: 14, padding: "16px 20px", display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
                        ...
                        <div style={{ flex: 1, minWidth: 140 }}>
                          ...
                          <div style={{ fontSize: 11, color: "#555" }}>
                            Purchased {item.purchasedAt ? new Date(item.purchasedAt).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) : ""}
                          </div>
                        </div>
                        <div style={{ display: "flex", gap: 8 }}>
                          <button
                            onClick={() => alert("Download links are generated server-side with signed, expiring URLs. Connect your /api/generate-download-link endpoint to enable this.")}
                            style={{ padding: "8px 16px", background: "transparent", color: "#00ffff", border: "1px solid #00ffff33", borderRadius: 8, cursor: "pointer", fontSize: 12, fontWeight: 700, transition: "0.2s" }}
                            onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(0,255,255,0.08)"; }}
                            onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; }}>
                            ↓ Download
                  ...
                  <div style={{ marginTop: 24, padding: "14px 18px", background: "#080808", border: "1px solid #1a1a1a", borderRadius: 12, fontSize: 12, color: "#444", lineHeight: 1.8 }}>
                    Download links are secure and generated on-demand. Connect <code style={{ color: "#00ffff" }}>/api/generate-download-link</code> to your backend to enable signed expiring URLs. Logged-in users can regenerate anytime.
                  </div>
                </>
              )}
            </>
            ...
            <>
              ...
              {currentUser ? (
                  ...
                  <div style={{ background: "#0d0d0d", border: "1px solid #1e1e1e", borderRadius: 20, padding: 28 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: 13, color: "#555", marginTop: 2 }}>{currentUser.email}</div>
                      </div>
                      {userStatus && (
                        <div style={{ marginLeft: "auto", fontSize: 10, fontWeight: 900, letterSpacing: 2, padding: "4px 12px", borderRadius: 20, background: userStatus.glow + "22", color: userStatus.color, border: `1px solid ${userStatus.color}44` }}>
                          {userStatus.label}
                        </div>
                      )}
                    </div>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", gap: 12 }}>
                      {[
                        { label: "Purchases", value: myPurchases.length },
                        { label: "Circle Posts", value: circleSubmissions.filter(s => s.by === currentUser.name).length },
                ...
                <div style={{ maxWidth: 400 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    {authMode === "signup" && (
                      <input placeholder="Full Name"
                        style={{ padding: "12px 14px", background: "#111", border: "1px solid #2a2a2a", color: "white", borderRadius: 10, fontSize: 14, outline: "none" }}
                    ...
                    <button
                      onClick={() => {
                        ...
                        setAuthError("Connect /api/auth to enable full login. For now the site uses the entry gate for fan capture.");
                      }}
                  ...
                  <div style={{ marginTop: 20, fontSize: 12, color: "#444", lineHeight: 1.9 }}>
                    Fan capture is handled by the site entry gate. Full auth requires connecting <code style={{ color: "#00ffff" }}>/api/auth</code> with session management.
                  </div>
                </div>
              )}
            </>
        ...
        <div style={{ flex: 1, borderLeft: "1px solid #222", padding: 25 }}>
          ...
          <button onClick={clearCart} style={{ marginTop: 15, width: "100%", padding: 14, background: "red", color: "white", fontWeight: "bold", border: "none", cursor: "pointer" }}>CLEAR CART</button>
          ...
          {currentUser && (
            <div>
              ...
              {userStatus && (
                <div style={{ marginTop: 6, textAlign: "center", fontSize: 10, fontWeight: 900, letterSpacing: 1, color: userStatus.color }}>
                  {userStatus.label}
                </div>
              )}
            </div>
